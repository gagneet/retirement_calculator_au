...
MISSING=0
for f in index.html advanced.html advanced-v2.html advanced-design.html reverse.html comparison.html contact.html privacy.html terms.html assumptions.html changelog.html methodology.html how-to-use.html robots.txt sitemap.xml; do
...
VERIFY_FAIL=0
for path in "" "advanced.html" "advanced-v2.html" "advanced-design.html" "reverse.html" "comparison.html" "contact.html"; do
