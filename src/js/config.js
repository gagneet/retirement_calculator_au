...
export const ENHANCED_CONFIG = {
    ...
    sources: {
        ...
        DEMING_THRESHOLDS: { source: 'Services Australia', lastUpdated: '2026-03-20', note: 'Rates 1.25%/3.25% per deep_research.md — live deeming page is a navigation hub, individual rates require drill-down. Verify at servicesaustralia.gov.au/deeming > Age Pension.', url: 'https://www.servicesaustralia.gov.au/deeming', previousValues: { lower: 0.0075, upper: 0.0275, asOf: '2025-09-20' }, verificationNote: 'PARTIALLY VERIFIED: pension maximums confirmed; deeming rates from research document only' },
