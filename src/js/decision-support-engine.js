...
export class DecisionSupportEngine {
    ...
    async generateComprehensiveRecommendations() {
        ...
        const prioritizedRecs = this.prioritizeRecommendations(recommendations, baseline);

        const disclaimerRec = {
            category: "AI Disclaimer",
            priority: "critical",
            action: "AI-Powered Recommendations Disclaimer",
            recommendation: "The following suggestions are generated by an AI engine based on the financial data you provided and simplified financial models. They are for educational and informational purposes only and <strong>do not constitute personal financial advice</strong>. Market conditions, regulations, and your personal situation can change. Always consult a qualified and licensed financial advisor before making any financial decisions.",
            summary: "The following suggestions are generated by an AI engine based on the financial data you provided and simplified financial models. They are for educational and informational purposes only and <strong>do not constitute personal financial advice</strong>. Market conditions, regulations, and your personal situation can change. Always consult a qualified and licensed financial advisor before making any financial decisions.",
            isDisclaimer: true
        };

        return [disclaimerRec, ...prioritizedRecs];
    }
